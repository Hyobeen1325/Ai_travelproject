        ...
        <div class="container">
            ...
            <div class="content-section">
                ...
                <div class="location-grid">
                    <div class="location-item">강릉시</div>
                    <div class="location-item">인제군</div>
                    <div class="location-item">정선군</div>
                    <div class="location-item">철원군</div>
                    <div class="location-item">춘천시</div>
                    <div class="location-item">태백시</div>
                    <div class="location-item">평창군</div>
                    <div class="location-item">홍천군</div>
                    <div class="location-item">화천군</div>
                    <div class="location-item">횡성군</div>
                    <div class="location-item">고성군</div>
                    <div class="location-item">동해시</div>
                </div>
