...
class ChatLog(Base):
    ...
    chat_log_id = Column(String(10), primary_key=True)  # e.g., a0001, a0002
    mem_email = Column(String(100), nullable=False)    # User email
    title = Column(String(200), nullable=False)        # Chat log title
...
class Qna(Base):
    ...
    qna_id = Column(String(10), primary_key=True)      # e.g., b001, b002
    chat_log_id = Column(String(10), nullable=False)   # Foreign key to chat_log
